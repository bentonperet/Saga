...
class DocsPublisher {
    ...
    this.requests.push({
      updateParagraphStyle: {
        ...
        paragraphStyle: {
          ...
          lineSpacing: brandStyle.lineSpacing * 100,
          spaceAbove: { magnitude: brandStyle.beforeSpacingPt, unit: 'PT' },
          spaceBelow: { magnitude: brandStyle.afterSpacingPt, unit: 'PT' }
        },
    ...
    this.requests.push({
      updateTextStyle: {
        ...
        textStyle: {
          ...
          fontSize: { magnitude: brandStyle.fontSizePt, unit: 'PT' },
          foregroundColor: {
    ...
    block.items.forEach(item => {
      ...
      this.requests.push({
        updateTextStyle: {
          ...
          textStyle: {
            fontSize: { magnitude: BRAND.BODY.fontSizePt, unit: 'PT' },
            foregroundColor: {
  ...
  insertCodeBlock(block) {
    ...
    this.requests.push({
      updateTextStyle: {
        ...
        textStyle: {
          fontSize: { magnitude: BRAND.CODE.fontSizePt, unit: 'PT' },
          foregroundColor: {
    ...
    this.requests.push({
      updateParagraphStyle: {
        ...
        paragraphStyle: {
          ...
          spaceAbove: { magnitude: BRAND.CODE.beforeSpacingPt, unit: 'PT' },
          spaceBelow: { magnitude: BRAND.CODE.afterSpacingPt, unit: 'PT' }
        },
  ...
  insertBlockquote(block) {
    block.blocks.forEach(innerBlock => {
      ...
      // Process the inner block normally
      ...
      this.requests.push({
        updateParagraphStyle: {
          range: { startIndex, endIndex },
          paragraphStyle: {
            indentStart: { magnitude: BRAND.BLOCKQUOTE.indentStart, unit: 'PT' },
            borderLeft: {
              color: { color: { rgbColor: hexToRgb(BRAND.BLOCKQUOTE.borderColor) } },
      ...
      // Override text color for blockquote
      this.requests.push({
        updateTextStyle: {
          range: { startIndex, endIndex: endIndex - 1 },
          textStyle: {
