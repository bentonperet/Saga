...
- **Parcel:** ~120 acres (49 ha) (master plan)
...
- **Building pad:** 50,000 GSF (4,645 m²) building (precast tilt-up) + aprons
- **Electrical yard:** ~100,000 SF (9,290 m²) (345 kV substation, MV gear, generator yard)
- **Mechanical yard:** ~50,000 SF (4,645 m²) (air-cooled chillers, pumps, headers)
- **Solar array area:** Allocate 10–20 acres (4-8 ha) adjacent (phased build)
...
- **Footprint:** ~35,000–50,000 SF (3,250-4,645 m²) fenced yard
...
- **Security:** 8–10 ft (2.4-3.0 m) fence + barbed wire, cameras, access control
...
- Pull boxes/manholes at 300–500 ft (91-152 m) intervals; spare conduits for expansion
...
- **Fuel:** ~2,000 gal (7,570 L) belly tanks per unit connected via common fuel manifold to centralized bulk fuel storage tank farm (24 hours runtime); spill containment per SPCC
- **Bulk Fuel Storage:** Above-ground or underground tank farm (~12,000 gal (45,420 L) capacity for Phase 2) with redundant fuel service contracts (24-hour SLA)
- **Noise:** Enclosures targeting ≤65 dBA @ 7 m (23 ft) at property line compliance
...
- **Layout:** Two rows with 15 ft (4.6 m) service corridors; overhead pipe racks to building
...
- Multiple small access doors (~dog door sized, approximately 24" × 24" (610 mm × 610 mm)) in building envelope at equipment yard boundaries
...
- **Fire lanes:** 20 ft (6.1 m) access; signage; clearances per NFPA 855 for energy storage
...
- **Access roads:** 12" (305 mm) aggregate base; asphalt or PCC pavement per truck loads
- **Dock apron:** 10" (254 mm) PCC with doweled joints
- **Parking:** 30–45 stalls; EV-ready conduits stubbed
- **Walks:** 6 ft (1.8 m) sidewalks to entries; ADA routes and ramps
...
- **Perimeter fence:** 8 ft (2.4 m) + 3-strand barbwire or ornamental steel (AHJ)
