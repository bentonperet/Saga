...
- **Division 21 – Fire Suppression** - *Pre-action sprinklers, clean agent for UPS rooms* - <!-- @claude link this properly -->
- **Division 22 – Plumbing** - *Domestic water, sanitary sewer, chilled water makeup* - <!-- @claude link this properly -->
- **Division 23 – HVAC** - *16 air-cooled chillers, CDUs, RDHx, rooftop AHUs* - <!-- @claude link this properly -->
- **Division 24** - *Reserved for Future Expansion*
- **Division 25 – Integrated Automation** - *BMS, DCIM, simplified EMS* - <!-- @claude link this properly -->
- **Division 26 – Electrical** - *N+1 modular UPS (dual paths), generators, switchboards, distribution* - <!-- @claude link this properly -->
- **Division 27 – Communications** - *Dual MMRs, fiber diversity, GCP interconnection* -<!-- @claude link this properly -->
- **Division 28 – Electronic Safety and Security** - *Access control, CCTV, intrusion detection* - <!-- @claude link this properly -->
...
- **Divisions 31-32 – Earthwork & Exterior Improvements** - *Grading, stormwater pond, equipment yards, landscaping* - <!-- @claude link this properly -->
- **Division 33 – Utilities** - *138kV interconnection, natural gas, water/sewer* - <!-- @claude link this properly -->
...
<!-- @claude, everything below this comment, I would like to make sure we don't lose this information and that it's contained somewhere. Also, it may be out of date. The information in the _BOD - Exec Summary is more up to date than this info - let's plan and then take action to comfortably delete everything below. -->
