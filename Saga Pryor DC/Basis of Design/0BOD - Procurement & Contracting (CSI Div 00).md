...
- **Critical path items** (order during design development, XX months into project):
  - Transformers (XX weeks)
  - Medium-voltage switchgear (XX weeks lead time)
  - UPS systems (XX weeks)
  - Generators (XX weeks)
  - Chillers (XX weeks)
...
## 3.0 CONTRACT TYPES & STRUCTURE

### Design-Build Prime Contract

---

## 4.0 VENDOR SELECTION CRITERIA
...
## 8.0 SPECIAL CONTRACT PROVISIONS
