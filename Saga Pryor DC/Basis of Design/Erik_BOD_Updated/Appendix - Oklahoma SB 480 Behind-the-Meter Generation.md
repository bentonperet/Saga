...
- 138 kV owner-constructed substation (2 × 25 MVA transformers, 138kV/11kV)
- 11 kV common bus architecture
- 6 × 4.0 MW diesel generators @ 11 kV (N+1 redundancy)
...
**Configuration:**
- Add 2-4 × natural gas turbine generators @ 11 kV
- Capacity: 3-5 MW each (similar to existing diesel generators)
- Integration: Parallel with 11 kV common bus
...
3. Install generators and integrate with 11 kV common bus
