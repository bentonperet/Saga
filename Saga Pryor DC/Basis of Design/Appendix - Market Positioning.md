...
- ✅ **Available capacity** (coastal markets tight/constrained)
- ✅ **Midwest reliability** (no earthquake/hurricane risk)

**Coastal Market Advantages:**
- ✅ Proximity to AWS (Ashburn) and major tech hubs (Santa Clara)
- ✅ Dense fiber network connectivity

**Trade-off:**
- Pryor not next to AWS/Azure, but Google adjacency is unique in region
...
- ✅ **Lower power costs** than Dallas

**Parity:**
- ≈ Similar power costs to Kansas City
- ≈ Similar labor markets
- ≈ Similar fiber connectivity

**Pryor's Unique Differentiator:**
- Only facility in the region with sub-millisecond latency to Google Cloud
